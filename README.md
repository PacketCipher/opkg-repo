...
### Menggunakan LuCI
  ...
  3. Pada bagian custom feeds tambahkan list dibawah ini
      ...
      ```
      src/gz custom_generic https://raw.githubusercontent.com/PacketCipher/opkg-repo/main/generic
      src/gz custom_arch https://raw.githubusercontent.com/PacketCipher/opkg-repo/main/arm_cortex-a7_neon-vfpv4
      ```

      ubah **arm_cortex-a7_neon-vfpv4** dan sesuaikan arsitektur CPU router OpenWrt kalian

      ![](https://raw.githubusercontent.com/PacketCipher/opkg-repo/main/preview/preview1.gif)
...
### Menggunakan Terminal
  ...
  2. Copy paste dibawah di terminal, otomatis akan menyesuaikan tipe arsitektur cpu router
      ...
      ![](https://raw.githubusercontent.com/PacketCipher/opkg-repo/main/preview/preview2.gif)
